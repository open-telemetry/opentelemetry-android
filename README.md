...
(Note: full javadoc can be found
at [javadoc.io](https://www.javadoc.io/doc/com.splunk/splunk-otel-android/latest/com/splunk/rum/Config.Builder.html))
...
- `filterSpans(Consumer<SpanFilterBuilder>)` :
  ...
  include: removing spans altogether from export, removing span attributes, changing span attributes or changing the span name.
  See the javadoc on the `SpanFilterBuilder` class for more details.

#### APIs provided by the `SplunkRum` instance:

(Note: full javadoc can be found
at [javadoc.io](https://www.javadoc.io/doc/com.splunk/splunk-otel-android/latest/com/splunk/rum/SplunkRum.html))
