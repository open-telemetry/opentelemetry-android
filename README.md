...
[![android api](https://img.shields.io/badge/Android_API-23-green.svg "Android min API 23")](VERSIONING.md)
...
dependencies {
    //...
    api(platform("io.opentelemetry.android:opentelemetry-android-bom:1.4.0-alpha"))
