...
class FilteringSpanExporterTest {
    ...
    @Test
    void filter() {
        SpanData span1 = TestSpanHelper.span("one");
        SpanData span2 = TestSpanHelper.span("two");
        SpanData span3 = TestSpanHelper.span("three");
        SpanData span4 = TestSpanHelper.span("four");
        SpanData span5 = TestSpanHelper.span("FIVE");
        Attributes attr6 = Attributes.of(stringKey("herp"), "derp");
        SpanData span6 = TestSpanHelper.span("six", attr6);
        Attributes attr7 = Attributes.of(stringKey("dig"), "dug");
        SpanData span7 = TestSpanHelper.span("seven", attr7);
        SpanData span8 = TestSpanHelper.span("eight");
