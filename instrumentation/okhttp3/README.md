...
```kotlin
implementation("io.opentelemetry.android.instrumentation:okhttp3-library:1.4.0-alpha")
byteBuddy("io.opentelemetry.android.instrumentation:okhttp3-agent:1.4.0-alpha")
```
