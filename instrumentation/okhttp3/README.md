...
```kotlin
implementation("io.opentelemetry.android.instrumentation:okhttp3-library:1.0.1-alpha")
byteBuddy("io.opentelemetry.android.instrumentation:okhttp3-agent:1.0.1-alpha")
```
