...
class AttributeModifyingSpanExporterTest {
    ...
    void testRemappedToNull() {
        ...
        SpanData span1 = TestSpanHelper.span("span1", Attributes.of(key, "bar"));
    ...
    void modify() {
        ...
        SpanData span1 = TestSpanHelper.span("span1", attr1);
        Attributes attr2 = buildAttr(2);
        SpanData span2 = TestSpanHelper.span("span2", attr2);
        Attributes attr3 = buildAttr(3);
        SpanData span3 = TestSpanHelper.span("span3", attr3);
        Collection<SpanData> spans = Arrays.asList(span1, span2, span3);
