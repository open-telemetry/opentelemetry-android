...
```kotlin
implementation("io.opentelemetry.android.instrumentation:android-log-library:1.5.0-alpha")
byteBuddy("io.opentelemetry.android.instrumentation:android-log-agent:1.5.0-alpha") // <2>
```
