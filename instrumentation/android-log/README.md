...
```kotlin
implementation("io.opentelemetry.android.instrumentation:android-log-library:1.4.0-alpha")
byteBuddy("io.opentelemetry.android.instrumentation:android-log-agent:1.4.0-alpha") // <2>
```
