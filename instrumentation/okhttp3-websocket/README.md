...
```kotlin
implementation("io.opentelemetry.android.instrumentation:okhttp3-websocket-library:1.0.0-alpha")
byteBuddy("io.opentelemetry.android.instrumentation:okhttp3-websocket-agent:1.0.0-alpha")
```
