...
```kotlin
implementation("io.opentelemetry.android.instrumentation:okhttp-library:1.2.0-alpha")
byteBuddy("io.opentelemetry.android.instrumentation:okhttp-agent:1.2.0-alpha")
```
