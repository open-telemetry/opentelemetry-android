...
```kotlin
implementation("io.opentelemetry.android.instrumentation:okhttp-library:OPENTELEMETRY_VERSION")
byteBuddy("io.opentelemetry.android.instrumentation:okhttp-agent:OPENTELEMETRY_VERSION")
```
